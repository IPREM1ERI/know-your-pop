...
const categoryFour = ["Name the group: UGod, Inspecta Deck, GZA, Raekwon the Chef",""]

const answers = ['seabiscuit', 'achilles', 'weasel', 'keanureeves', 'wutang', 'wutangclan', 'kobe', 'cowboys', 'dallascowboys']