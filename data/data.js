...
const sportQuestion = ["If you say his name before you shoot a crumpled piece of paper, your odds increase of it going in", "Name the team: Troy, Emmitt, Michale, Jimmy","This team has won more World Series titles than the next 3 teams combined","This Polk High Legend once scored 4 touchdowns in 1 game"]
...
const answersArr = ['seabiscuit', 'achilles', 'weasel', 'keanureeves', 'wutang', 'wutangclan', 'kobe', 'cowboys', 'dallascowboys', 'kurtcobain', "icecube","fightclub","houseoftherisingsun", "pringles", "electoralcollege","joydivision","yankees","newyorkyankees", "breakdancing","quentintarantino","albundy"]
